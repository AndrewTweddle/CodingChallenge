...
class ListingMatcherTestCase(unittest.TestCase):
    ...
    def testWithSingleMatcherMatchingProductDesc(self):
        ...
        self.assertEqual(match_result.description, 'ManySecondaryRules', 'The rule description should be "ManySecondaryRules" when the single matcher matches the rule')
    ...
    def testWithSingleMatcherAndMultipleMatchingRules(self):
        ...
        self.assertEqual(match_result.is_match, True, "There should be a match when the single matcher's product desc matches the primary text")
        self.assertEqual(match_result.match_value, 1062)
        self.assertEqual(match_result.description, 'ManySecondaryRules')
    ...
    def testWithMultipleMatchers(self):
        ...
        self.assertEqual(match_result.description, 'SingleSecondaryRule')
